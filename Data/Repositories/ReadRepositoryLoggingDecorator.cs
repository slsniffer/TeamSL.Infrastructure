...
namespace TeamSL.Infrastructure.Data
{
    public class ReadRepositoryLoggingDecorator<TRecord> : IReadRepository<TRecord> where TRecord : Record
    {
        ...
        {
            Logger.Debug("Loading {0}.Id: {0}", typeof(TRecord).Name, id);
        ...
        {
            Logger.Debug("Loading {0}.Id: {1} with fetching: {2}", typeof(TRecord).Name, id, fetchStrategy.GetType().Name);
        ...
        {
            Logger.Debug("Find {0} by specification: {1}", typeof(TRecord).Name, specification.GetType().Name);
        ...
        {
            Logger.Debug("Find {0} by specification: {1} with fetching: {2}", typeof(TRecord).Name, specification.GetType().Name, fetchStrategy.GetType().Name);
        ...
        {
            Logger.Debug("Counting {0}", typeof(TRecord).Name);
        ...
        {
            Logger.Debug("Counting {0} with spec: {1}", typeof(TRecord).Name, specification.GetType().Name);
        ...
        {
            Logger.Debug("Find all {0}", typeof(TRecord).Name);
        ...
        {
            Logger.Debug("Find all {0} with ordering", typeof(TRecord).Name);
        ...
        {
            Logger.Debug("Find all {0} with ordering, skip:{1}, count:{2}", typeof(TRecord).Name, skip, count);
        ...
        {
            Logger.Debug("Find all {0} with spec:{1}", typeof(TRecord).Name, specification.GetType().Name);
        ...
        {
            Logger.Debug("Find all {0} with spec:{1} and ordering", typeof(TRecord).Name, specification.GetType().Name);
        ...
        {
            Logger.Debug("Find all {0} with spec:{1} and ordering, skip:{2}, count:{3}", typeof(TRecord).Name, specification.GetType().Name, skip, count);
        ...
        {
            Logger.Debug("Find all {0} with spec:{1}, fetch:{2}", typeof(TRecord).Name, specification.GetType().Name, fetchStrategy.GetType().Name);
        ...
        {
            Logger.Debug("Find all {0} with spec:{1}, fetch:{2} and ordering", typeof(TRecord).Name, specification.GetType().Name, fetchStrategy.GetType().Name);
        ...
        IList<TRecord> IReadRepository<TRecord>.FindAll(IQuerySpecification<TRecord> specification, IFetchStrategy<TRecord> fetchStrategy, Action<Orderable<TRecord>> order,
            int skip, int count)
        {
            Logger.Debug("Find all {0} with spec:{1}, fetch:{2} and ordering, skip:{3}, count:{4}", typeof(TRecord).Name, specification.GetType().Name,
        ...
        {
            Logger.Debug("Find all {0} with fetch:{1}", typeof(TRecord).Name, fetchStrategy.GetType().Name);
        ...
        {
            Logger.Debug("Find all {0} with fetch:{1} and ordering, skip:{2}, count:{3}", typeof(TRecord).Name, fetchStrategy.GetType().Name, skip, count);
